...
<div class="g4 mb2">
  <div class="stat-card"><div class="stat-val sv-r" style="font-size:22px;"><?= (int)($stats['total']??0) ?></div><div class="stat-lbl">Awarii łącznie</div></div>
  <div class="stat-card"><div class="stat-val sv-a" style="font-size:22px;"><?= (int)($stats['open_count']??0) ?></div><div class="stat-lbl">Otwarte</div></div>
  <div class="stat-card"><div class="stat-val sv-g" style="font-size:22px;"><?= (int)($stats['closed_count']??0) ?></div><div class="stat-lbl">Zamknięte</div></div>
  <div class="stat-card"><div class="stat-val sv-v" style="font-size:22px;"><?= Helpers::e($stats['avg_repair_str']??'—') ?></div><div class="stat-lbl">Śr. czas naprawy</div></div>
</div>
  ...
  <div>
    ...
    <div class="card">
      <div class="card-head"><span class="card-title">Przeglądy DUR</span>
        <a href="<?= BASE_URL ?>/index.php?route=dur" class="btn btn-sm">Wszystkie</a></div>
