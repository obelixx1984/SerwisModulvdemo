  ...
  <div class="app-shell">
    <nav class="sidebar">
      <div class="sidebar-logo">
        ...
        <div class="sidebar-logo-text"><?= htmlspecialchars($appName) ?><small id="appVersionBtn" style="cursor:pointer;" onclick="openChangelogModal()" title="Historia zmian"><?= htmlspecialchars($appVersion) ?></small></div>
      </div>
