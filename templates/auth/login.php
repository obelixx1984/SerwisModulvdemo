...
body{font-family:Arial,Helvetica,sans-serif;background:#f0f2f7;min-height:100vh;display:flex;align-items:center;justify-content:center;}
.login-wrap{display:flex;align-items:center;justify-content:center;min-height:100vh;padding:24px;width:100%;}
...
.lbl{width:100%;font-size:12px;font-weight:600;color:#6b7280;margin-bottom:4px;display:block;}
...
.alert-e{background:#fef2f2;border:1px solid #fca5a5;color:#7f1d1d;border-radius:7px;padding:8px 12px;font-size:13px;width:100%;margin-bottom:10px;}
.alert-s{background:#ecfdf5;border:1px solid #a7f3d0;color:#065f46;border-radius:7px;padding:8px 12px;font-size:13px;width:100%;margin-bottom:10px;}
</style>
</head>
<body>
<div class="login-wrap">
  <div class="login-card">
    ...
    <div class="login-sub">System zarządzania serwisem produkcji</div>
    ...
    <form method="POST" action="<?= BASE_URL ?>/index.php?route=login_post" style="width:100%;">
      ...
      <input class="lfc" type="text" name="nickname" placeholder="Wpisz nickname"
    ...
    <p style="margin-top:16px;font-size:12px;text-align:center;">
      <a href="<?= BASE_URL ?>/index.php?route=report" style="color:#0a2463;">← Wróć do formularza zgłoszenia</a>
    </p>
  </div>
</div>
</body>
